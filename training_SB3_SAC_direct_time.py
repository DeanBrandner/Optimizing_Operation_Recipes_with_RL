...
from environments_RL import Poly_reactor_SB3_direct_time as Environment
from stable_baselines3.common.monitor import Monitor
from stable_baselines3 import SAC

from stable_baselines3.common.callbacks import EvalCallback, StopTrainingOnNoModelImprovement
from SaveModelCallback import SaveOnBestTrainingRewardCallback_direct as SaveOnBest
import torch as th
...
if __name__ == "__main__":
    ...
    save_path = f"D:\\recipe_opt\\data\\poly_reactor\\agent\\SB3_SAC_{model_nb}_direct_time\\"
    fig_path = f"D:\\recipe_opt\\figs\\poly_reactor\\agent\\SB3_SAC_{model_nb}_direct_time\\"
    ...
    savebest_callback = SaveOnBest(check_freq=check_freq, log_dir=save_path)
